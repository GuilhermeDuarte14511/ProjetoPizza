export const queryKeys = {
  ...
  serviceCalls: ['admin', 'service-calls'] as const,
  ...
  loyalty: ['admin', 'loyalty'] as const,
  ...
  cashShiftHistory: ['admin', 'cashier', 'history'] as const,
  ...
  printJobs: ['admin', 'print-jobs'] as const,
  users: ['admin', 'users'] as const,
  roles: ['admin', 'roles'] as const,
  audit: ['admin', 'audit'] as const,
  systemSnapshot: ['admin', 'system', 'snapshot'] as const,
  diningAreas: ['admin', 'settings', 'dining-areas'] as const,
  tableSettings: ['admin', 'settings', 'tables'] as const,
