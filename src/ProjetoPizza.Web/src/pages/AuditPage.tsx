...
export function AuditPage() {
  ...
  const visible = useMemo(() => logs.filter((log) => `${log.module} ${log.action} ${log.entityType} ${log.employee ?? ''}`.toLowerCase().includes(search.toLowerCase())), [logs, search])
