...
export const mockFinancialReport: FinancialReport = {
  ...
  paidAmount: 47290.4,
  foodCost: 14556.24,
  contributionMargin: 33964.56,
  contributionMarginPercentage: 70,
  averageTicket: 72.65,
  orderCount: 668,
  completedTickets: 712,
  averagePreparationMinutes: 16.8,
  onTimeRate: 84.4,
  channels: [
  ...
  productionStations: [
    { station: 'Forno', tickets: 430, averagePreparationMinutes: 18.2, onTimeRate: 82.1 },
    { station: 'Cozinha', tickets: 282, averagePreparationMinutes: 14.6, onTimeRate: 87.9 },
  ],
}
