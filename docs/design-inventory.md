...
| Relatórios financeiros | `designs/relat_rios_financeiros_forno_27/code.html` | Analisar resultado | período, métricas, gráficos, exportar | Order, Payment, CashMovement | Analytics detalhado fica para uma etapa posterior. |
